...
// POST — disable MFA. Requires a valid current code so a hijacked browser
// session alone can't silently strip MFA protection off the account.
export async function POST(req: NextRequest) {
  ...
  void logAudit({ action: 'UPDATE', resource: 'auth', resourceId: userId, ipAddress: getClientIp(req), after: { mfaEnabled: false } })
